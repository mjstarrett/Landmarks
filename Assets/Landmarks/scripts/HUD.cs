...
public class HUD : MonoBehaviour {
	...
	public GameObject CanvasCompass;
	...
	{
		print ("HUD_AWAKE!!!!!!!!!!!!!!!!!!");
		canvan = Canvas.GetComponent(canvasName.ToString ()).GetComponent<Text>();
		canvancompass = CanvasCompass.GetComponent(canvasName.ToString ()).GetComponent<Text>();
	}
	...
	void updateMessage()
	{
	    ...
	    canvan.text = hidemessage ? string.Empty : message;
		canvancompass.text = compassmessage;
